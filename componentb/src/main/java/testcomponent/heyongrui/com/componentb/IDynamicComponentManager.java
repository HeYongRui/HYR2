...
public class IDynamicComponentManager {
    public static final String KEY_USER = "user";

    /**
     * 当前登录用户
     */
    private static Global.User loginUser;
    ...
    public static void setLoginUser(Global.User user) {
        if (user != loginUser) {
            loginUser = user;
    ...
    public static Global.User getLoginUser() {
        return loginUser;
    }
}
