package testcomponent.heyongrui.com.componenta.net.dto;
...
public class MonoTabDto implements Parcelable {
        ...
        public static class MeowBean implements Parcelable {
            ...
            public static class GroupBean implements Parcelable {
                ...
                public static class MasterInfoBean implements Parcelable {
                    ...
                    public static final Parcelable.Creator<MasterInfoBean> CREATOR = new Parcelable.Creator<MasterInfoBean>() {
                        @Override
            ...
            public static class ThumbBean implements Parcelable {
                ...
                public static final Parcelable.Creator<ThumbBean> CREATOR = new Parcelable.Creator<ThumbBean>() {
                    @Override
            ...
            public static final Parcelable.Creator<MeowBean> CREATOR = new Parcelable.Creator<MeowBean>() {
                @Override
    ...
    public static final Parcelable.Creator<MonoTabDto> CREATOR = new Parcelable.Creator<MonoTabDto>() {
        @Override
