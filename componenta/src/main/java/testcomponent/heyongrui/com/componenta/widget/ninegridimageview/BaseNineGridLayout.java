...
public abstract class BaseNineGridLayout<T> extends ViewGroup {
    ...
    public void setImagesData(List<T> urlList) {
    ...
    private void refresh() {
        ...
        if (size == 1) {
            ...
            boolean isShowDefualt = displayOneImage(imageView, t, mTotalWidth);
            if (isShowDefualt) {
    ...
    private RatioImageView createImageView(final int i, final T t) {
        ...
        imageView.setOnClickListener(v -> {
            if (mItemImageClickListener != null) {
                mItemImageClickListener.onItemImageClick(getContext(), BaseNineGridLayout.this, imageView, i, t, mDataList);
            }
        });
     ...
     */
    private void layoutImageView(RatioImageView imageView, int i, T url, boolean showNumFlag) {
...
//        params.width = width;
     ...
     */
    protected abstract boolean displayOneImage(RatioImageView imageView, T url, int parentWidth);

    protected abstract void displayImage(RatioImageView imageView, T url);
}
