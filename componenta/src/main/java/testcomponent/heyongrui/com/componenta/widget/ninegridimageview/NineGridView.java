...
public class NineGridView<T> extends ViewGroup {
    ...
    public NineGridView(Context context, AttributeSet attrs) {
        ...
        this.mSingleImgSize = typedArray.getDimensionPixelSize(R.styleable.NineGridView_singleImgSize, -1);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mImgDataList != null && mImgDataList.size() > 0) {
            if (mImgDataList.size() == 1) {
                mSingleImgSize = mSingleImgSize > totalWidth ? totalWidth : mSingleImgSize;
                mGridSize = mSingleImgSize == -1 ? totalWidth : mSingleImgSize;
            } else {
